...
const FETCH_ALL_USERS_QUERY = "SELECT id, fullname, login FROM public.users WHERE id != $1" + AND_DELETED_COLUMN_CHECK;
const INSERT_USER_MESSAGE_QUERY = "INSERT INTO messages (sender_id, recipient_id, message_text) VALUES ($1, $2, $3)" + RETURNING_ALL;
const FETCH_USER_QUERY = "SELECT id, fullname FROM public.users WHERE id = $1" + RETURNING_ALL;
